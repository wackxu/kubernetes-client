...
public class EventListFluentImpl<A extends EventListFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements EventListFluent<A>{

    private String apiVersion;
    private List<EventBuilder> items;
    private String kind;
    ...
    public A addToItems(int index,Event item){
            if (this.items == null) {this.items = new ArrayList<EventBuilder>();}
...
@Deprecated public List<Event> getItems(){
    ...
    public Event buildMatchingItem(io.fabric8.kubernetes.api.builder.Predicate<EventBuilder> predicate){
            for (EventBuilder item: items) { if(predicate.apply(item)){return item.build();} } return null;
    }

    public A withItems(List<Event> items){
            if (this.items != null) { _visitables.removeAll(this.items);}
            if (items != null) {this.items = new ArrayList<EventBuilder>(); for (Event item : items){this.addToItems(item);}} else { this.items = new ArrayList<EventBuilder>();} return (A) this;
    }
...
@Deprecated public ListMeta getMetadata(){
    ...
    public class ItemsNestedImpl<N> extends EventFluentImpl<EventListFluent.ItemsNested<N>> implements EventListFluent.ItemsNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{

            private final EventBuilder builder;
        private final int index;
    
            ItemsNestedImpl(int index,Event item){
                    this.index = index;
    ...
    public N and(){
            return (N) EventListFluentImpl.this.setToItems(index, builder.build());
    }
    public N endItem(){
            return and();
    }
    ...
    public class MetadataNestedImpl<N> extends ListMetaFluentImpl<EventListFluent.MetadataNested<N>> implements EventListFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
