...
public class PodFluentImpl<A extends PodFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements PodFluent<A>{
...
@Deprecated public PodStatus getStatus(){
    ...
    public PodFluent.StatusNested<A> editOrNewStatus(){
            return withNewStatusLike(getStatus() != null ? getStatus(): new PodStatusBuilder().build());
    }
    ...
    public class MetadataNestedImpl<N> extends ObjectMetaFluentImpl<PodFluent.MetadataNested<N>> implements PodFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public class SpecNestedImpl<N> extends PodSpecFluentImpl<PodFluent.SpecNested<N>> implements PodFluent.SpecNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public class StatusNestedImpl<N> extends PodStatusFluentImpl<PodFluent.StatusNested<N>> implements PodFluent.StatusNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
