...
public class PodListFluentImpl<A extends PodListFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements PodListFluent<A>{

    private String apiVersion;
    private List<PodBuilder> items;
    private String kind;
    ...
    public A addToItems(int index,Pod item){
            if (this.items == null) {this.items = new ArrayList<PodBuilder>();}
...
@Deprecated public List<Pod> getItems(){
    ...
    public Pod buildMatchingItem(io.fabric8.kubernetes.api.builder.Predicate<PodBuilder> predicate){
            for (PodBuilder item: items) { if(predicate.apply(item)){return item.build();} } return null;
    }

    public A withItems(List<Pod> items){
            if (this.items != null) { _visitables.removeAll(this.items);}
            if (items != null) {this.items = new ArrayList<PodBuilder>(); for (Pod item : items){this.addToItems(item);}} else { this.items = new ArrayList<PodBuilder>();} return (A) this;
    }

    public A withItems(Pod... items){
            if (this.items != null) {this.items.clear();}
            if (items != null) {for (Pod item :items){ this.addToItems(item);}} return (A) this;
    }
...
@Deprecated public ListMeta getMetadata(){
    ...
    public boolean equals(Object o){
            ...
            PodListFluentImpl that = (PodListFluentImpl) o;
    ...
    public class ItemsNestedImpl<N> extends PodFluentImpl<PodListFluent.ItemsNested<N>> implements PodListFluent.ItemsNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{

            private final PodBuilder builder;
        private final int index;
    
            ItemsNestedImpl(int index,Pod item){
                    this.index = index;
    ...
    public N and(){
            return (N) PodListFluentImpl.this.setToItems(index, builder.build());
    }
    public N endItem(){
            return and();
    }
    ...
    public class MetadataNestedImpl<N> extends ListMetaFluentImpl<PodListFluent.MetadataNested<N>> implements PodListFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) PodListFluentImpl.this.withMetadata(builder.build());
    }
