...
public class ServiceFluentImpl<A extends ServiceFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements ServiceFluent<A>{
...
@Deprecated public ServiceSpec getSpec(){
    ...
    public A withSpec(ServiceSpec spec){
            ...
            if (spec!=null){ this.spec= new ServiceSpecBuilder(spec); _visitables.add(this.spec);} return (A) this;
    }
...
@Deprecated public ServiceStatus getStatus(){
    ...
    public A withStatus(ServiceStatus status){
            ...
            if (status!=null){ this.status= new ServiceStatusBuilder(status); _visitables.add(this.status);} return (A) this;
    }
