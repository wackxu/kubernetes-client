...
@Deprecated public ReplicaSetStatus getStatus(){
    ...
    public class MetadataNestedImpl<N> extends ObjectMetaFluentImpl<ReplicaSetFluent.MetadataNested<N>> implements ReplicaSetFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public class SpecNestedImpl<N> extends ReplicaSetSpecFluentImpl<ReplicaSetFluent.SpecNested<N>> implements ReplicaSetFluent.SpecNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public class StatusNestedImpl<N> extends ReplicaSetStatusFluentImpl<ReplicaSetFluent.StatusNested<N>> implements ReplicaSetFluent.StatusNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
