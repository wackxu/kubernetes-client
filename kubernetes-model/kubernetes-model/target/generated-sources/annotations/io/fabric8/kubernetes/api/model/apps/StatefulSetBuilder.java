...
public class StatefulSetBuilder extends StatefulSetFluentImpl<StatefulSetBuilder> implements VisitableBuilder<StatefulSet,StatefulSetBuilder>{
    ...
    public StatefulSetBuilder(Validator validator){
            this(new StatefulSet(), true);
    }
    public StatefulSetBuilder(StatefulSetFluent<?> fluent,StatefulSet instance,Validator validator){
            this.fluent = fluent; 
            fluent.withApiVersion(instance.getApiVersion()); 
            fluent.withKind(instance.getKind()); 
            fluent.withMetadata(instance.getMetadata()); 
    ...
    public StatefulSetBuilder(StatefulSet instance,Validator validator){
            this.fluent = this; 
            this.withApiVersion(instance.getApiVersion()); 
            this.withKind(instance.getKind()); 
            this.withMetadata(instance.getMetadata()); 
