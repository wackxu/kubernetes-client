...
public class StatefulSetListFluentImpl<A extends StatefulSetListFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements StatefulSetListFluent<A>{

    private String apiVersion;
    private List<StatefulSetBuilder> items;
    private String kind;
    private ListMetaBuilder metadata;

    public StatefulSetListFluentImpl(){
    }
    public StatefulSetListFluentImpl(StatefulSetList instance){
    ...
    public A addToItems(int index,StatefulSet item){
            if (this.items == null) {this.items = new ArrayList<StatefulSetBuilder>();}
...
@Deprecated public List<StatefulSet> getItems(){
    ...
    public StatefulSet buildMatchingItem(io.fabric8.kubernetes.api.builder.Predicate<StatefulSetBuilder> predicate){
            for (StatefulSetBuilder item: items) { if(predicate.apply(item)){return item.build();} } return null;
    }

    public A withItems(List<StatefulSet> items){
            if (this.items != null) { _visitables.removeAll(this.items);}
            if (items != null) {this.items = new ArrayList<StatefulSetBuilder>(); for (StatefulSet item : items){this.addToItems(item);}} else { this.items = new ArrayList<StatefulSetBuilder>();} return (A) this;
    }

    public A withItems(StatefulSet... items){
            if (this.items != null) {this.items.clear();}
            if (items != null) {for (StatefulSet item :items){ this.addToItems(item);}} return (A) this;
    }
...
@Deprecated public ListMeta getMetadata(){
    ...
    public boolean equals(Object o){
            ...
            StatefulSetListFluentImpl that = (StatefulSetListFluentImpl) o;
    ...
    public class ItemsNestedImpl<N> extends StatefulSetFluentImpl<StatefulSetListFluent.ItemsNested<N>> implements StatefulSetListFluent.ItemsNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{

            private final StatefulSetBuilder builder;
        private final int index;
    
            ItemsNestedImpl(int index,StatefulSet item){
                    this.index = index;
    ...
    public N and(){
            return (N) StatefulSetListFluentImpl.this.setToItems(index, builder.build());
    }
    public N endItem(){
            return and();
    }
    ...
    public class MetadataNestedImpl<N> extends ListMetaFluentImpl<StatefulSetListFluent.MetadataNested<N>> implements StatefulSetListFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) StatefulSetListFluentImpl.this.withMetadata(builder.build());
    }
