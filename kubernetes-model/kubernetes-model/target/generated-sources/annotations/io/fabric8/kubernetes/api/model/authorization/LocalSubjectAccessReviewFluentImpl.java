...
public class LocalSubjectAccessReviewFluentImpl<A extends LocalSubjectAccessReviewFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements LocalSubjectAccessReviewFluent<A>{
...
@Deprecated public SubjectAccessReviewStatus getStatus(){
    ...
    public class MetadataNestedImpl<N> extends ObjectMetaFluentImpl<LocalSubjectAccessReviewFluent.MetadataNested<N>> implements LocalSubjectAccessReviewFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) LocalSubjectAccessReviewFluentImpl.this.withMetadata(builder.build());
    }
    ...
    public class SpecNestedImpl<N> extends SubjectAccessReviewSpecFluentImpl<LocalSubjectAccessReviewFluent.SpecNested<N>> implements LocalSubjectAccessReviewFluent.SpecNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) LocalSubjectAccessReviewFluentImpl.this.withSpec(builder.build());
    }
    public N endSpec(){
            return and();
    }
    ...
    public class StatusNestedImpl<N> extends SubjectAccessReviewStatusFluentImpl<LocalSubjectAccessReviewFluent.StatusNested<N>> implements LocalSubjectAccessReviewFluent.StatusNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) LocalSubjectAccessReviewFluentImpl.this.withStatus(builder.build());
    }
    public N endStatus(){
            return and();
    }
