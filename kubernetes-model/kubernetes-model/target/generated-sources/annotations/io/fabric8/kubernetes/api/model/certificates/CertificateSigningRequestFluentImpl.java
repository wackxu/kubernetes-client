...
public class CertificateSigningRequestFluentImpl<A extends CertificateSigningRequestFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements CertificateSigningRequestFluent<A>{
    ...
    public CertificateSigningRequestFluentImpl(CertificateSigningRequest instance){
...
@Deprecated public CertificateSigningRequestSpec getSpec(){
    ...
    public A withSpec(CertificateSigningRequestSpec spec){
            ...
            if (spec!=null){ this.spec= new CertificateSigningRequestSpecBuilder(spec); _visitables.add(this.spec);} return (A) this;
    }
...
@Deprecated public CertificateSigningRequestStatus getStatus(){
    ...
    public A withStatus(CertificateSigningRequestStatus status){
            ...
            if (status!=null){ this.status= new CertificateSigningRequestStatusBuilder(status); _visitables.add(this.status);} return (A) this;
    }
    ...
    public boolean equals(Object o){
            ...
            CertificateSigningRequestFluentImpl that = (CertificateSigningRequestFluentImpl) o;
    ...
    public class MetadataNestedImpl<N> extends ObjectMetaFluentImpl<CertificateSigningRequestFluent.MetadataNested<N>> implements CertificateSigningRequestFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) CertificateSigningRequestFluentImpl.this.withMetadata(builder.build());
    }
    ...
    public class SpecNestedImpl<N> extends CertificateSigningRequestSpecFluentImpl<CertificateSigningRequestFluent.SpecNested<N>> implements CertificateSigningRequestFluent.SpecNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{

            private final CertificateSigningRequestSpecBuilder builder;
    
            SpecNestedImpl(CertificateSigningRequestSpec item){
    ...
    public N and(){
            return (N) CertificateSigningRequestFluentImpl.this.withSpec(builder.build());
    }
    public N endSpec(){
            return and();
    }
    ...
    public class StatusNestedImpl<N> extends CertificateSigningRequestStatusFluentImpl<CertificateSigningRequestFluent.StatusNested<N>> implements CertificateSigningRequestFluent.StatusNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{

            private final CertificateSigningRequestStatusBuilder builder;
    
            StatusNestedImpl(CertificateSigningRequestStatus item){
    ...
    public N and(){
            return (N) CertificateSigningRequestFluentImpl.this.withStatus(builder.build());
    }
    public N endStatus(){
            return and();
    }
