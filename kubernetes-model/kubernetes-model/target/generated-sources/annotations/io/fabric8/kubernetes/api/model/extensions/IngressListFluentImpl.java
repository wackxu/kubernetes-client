...
public class IngressListFluentImpl<A extends IngressListFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements IngressListFluent<A>{
    ...
    private List<IngressBuilder> items;
    private String kind;
    ...
    public A addToItems(int index,Ingress item){
            if (this.items == null) {this.items = new ArrayList<IngressBuilder>();}
...
@Deprecated public List<Ingress> getItems(){
    ...
    public Ingress buildMatchingItem(io.fabric8.kubernetes.api.builder.Predicate<IngressBuilder> predicate){
            for (IngressBuilder item: items) { if(predicate.apply(item)){return item.build();} } return null;
    }

    public A withItems(List<Ingress> items){
            if (this.items != null) { _visitables.removeAll(this.items);}
            if (items != null) {this.items = new ArrayList<IngressBuilder>(); for (Ingress item : items){this.addToItems(item);}} else { this.items = new ArrayList<IngressBuilder>();} return (A) this;
    }

    public A withItems(Ingress... items){
            if (this.items != null) {this.items.clear();}
            if (items != null) {for (Ingress item :items){ this.addToItems(item);}} return (A) this;
    }
...
@Deprecated public ListMeta getMetadata(){
    ...
    public boolean equals(Object o){
            ...
            IngressListFluentImpl that = (IngressListFluentImpl) o;
    ...
    public class ItemsNestedImpl<N> extends IngressFluentImpl<IngressListFluent.ItemsNested<N>> implements IngressListFluent.ItemsNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{

            private final IngressBuilder builder;
        private final int index;
    
            ItemsNestedImpl(int index,Ingress item){
                    this.index = index;
    ...
    public N and(){
            return (N) IngressListFluentImpl.this.setToItems(index, builder.build());
    }
    public N endItem(){
            return and();
    }
    ...
    public class MetadataNestedImpl<N> extends ListMetaFluentImpl<IngressListFluent.MetadataNested<N>> implements IngressListFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) IngressListFluentImpl.this.withMetadata(builder.build());
    }
