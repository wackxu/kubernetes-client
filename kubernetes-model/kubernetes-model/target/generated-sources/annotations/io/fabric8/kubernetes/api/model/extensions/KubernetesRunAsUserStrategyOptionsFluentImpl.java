...
public class KubernetesRunAsUserStrategyOptionsFluentImpl<A extends KubernetesRunAsUserStrategyOptionsFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements KubernetesRunAsUserStrategyOptionsFluent<A>{
...
@Deprecated public List<IDRange> getRanges(){
    ...
    public boolean equals(Object o){
            ...
            KubernetesRunAsUserStrategyOptionsFluentImpl that = (KubernetesRunAsUserStrategyOptionsFluentImpl) o;
    ...
    public class RangesNestedImpl<N> extends IDRangeFluentImpl<KubernetesRunAsUserStrategyOptionsFluent.RangesNested<N>> implements KubernetesRunAsUserStrategyOptionsFluent.RangesNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) KubernetesRunAsUserStrategyOptionsFluentImpl.this.setToRanges(index, builder.build());
    }
    public N endRange(){
            return and();
    }
