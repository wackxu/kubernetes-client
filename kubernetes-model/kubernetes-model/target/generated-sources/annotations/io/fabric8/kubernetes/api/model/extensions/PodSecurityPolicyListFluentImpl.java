...
public class PodSecurityPolicyListFluentImpl<A extends PodSecurityPolicyListFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements PodSecurityPolicyListFluent<A>{

    private String apiVersion;
    private List<PodSecurityPolicyBuilder> items;
    private String kind;
    private ListMetaBuilder metadata;

    public PodSecurityPolicyListFluentImpl(){
    }
    public PodSecurityPolicyListFluentImpl(PodSecurityPolicyList instance){
    ...
    public A addToItems(int index,PodSecurityPolicy item){
            if (this.items == null) {this.items = new ArrayList<PodSecurityPolicyBuilder>();}
...
@Deprecated public List<PodSecurityPolicy> getItems(){
    ...
    public PodSecurityPolicy buildMatchingItem(io.fabric8.kubernetes.api.builder.Predicate<PodSecurityPolicyBuilder> predicate){
            for (PodSecurityPolicyBuilder item: items) { if(predicate.apply(item)){return item.build();} } return null;
    }

    public A withItems(List<PodSecurityPolicy> items){
            if (this.items != null) { _visitables.removeAll(this.items);}
            if (items != null) {this.items = new ArrayList<PodSecurityPolicyBuilder>(); for (PodSecurityPolicy item : items){this.addToItems(item);}} else { this.items = new ArrayList<PodSecurityPolicyBuilder>();} return (A) this;
    }

    public A withItems(PodSecurityPolicy... items){
            if (this.items != null) {this.items.clear();}
            if (items != null) {for (PodSecurityPolicy item :items){ this.addToItems(item);}} return (A) this;
    }
...
@Deprecated public ListMeta getMetadata(){
    ...
    public boolean equals(Object o){
            ...
            PodSecurityPolicyListFluentImpl that = (PodSecurityPolicyListFluentImpl) o;
    ...
    public class ItemsNestedImpl<N> extends PodSecurityPolicyFluentImpl<PodSecurityPolicyListFluent.ItemsNested<N>> implements PodSecurityPolicyListFluent.ItemsNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{

            private final PodSecurityPolicyBuilder builder;
        private final int index;
    
            ItemsNestedImpl(int index,PodSecurityPolicy item){
                    this.index = index;
    ...
    public N and(){
            return (N) PodSecurityPolicyListFluentImpl.this.setToItems(index, builder.build());
    }
    public N endItem(){
            return and();
    }
    ...
    public class MetadataNestedImpl<N> extends ListMetaFluentImpl<PodSecurityPolicyListFluent.MetadataNested<N>> implements PodSecurityPolicyListFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) PodSecurityPolicyListFluentImpl.this.withMetadata(builder.build());
    }
