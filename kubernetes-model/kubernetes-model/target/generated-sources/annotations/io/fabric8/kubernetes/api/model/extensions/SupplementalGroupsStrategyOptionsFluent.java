...
@Deprecated public List<IDRange> getRanges();
    ...
    public SupplementalGroupsStrategyOptionsFluent.RangesNested<A> setNewRangeLike(int index,IDRange item);
    ...
    public SupplementalGroupsStrategyOptionsFluent.RangesNested<A> editMatchingRange(io.fabric8.kubernetes.api.builder.Predicate<IDRangeBuilder> predicate);
    public String getRule();
    public A withRule(String rule);
    public Boolean hasRule();

    public interface RangesNested<N> extends io.fabric8.kubernetes.api.builder.Nested<N>,IDRangeFluent<SupplementalGroupsStrategyOptionsFluent.RangesNested<N>>{
