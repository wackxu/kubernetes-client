...
@Deprecated public List<Subject> getSubjects(){
    ...
    public class MetadataNestedImpl<N> extends ObjectMetaFluentImpl<RoleBindingFluent.MetadataNested<N>> implements RoleBindingFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public class RoleRefNestedImpl<N> extends RoleRefFluentImpl<RoleBindingFluent.RoleRefNested<N>> implements RoleBindingFluent.RoleRefNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public class SubjectsNestedImpl<N> extends SubjectFluentImpl<RoleBindingFluent.SubjectsNested<N>> implements RoleBindingFluent.SubjectsNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
