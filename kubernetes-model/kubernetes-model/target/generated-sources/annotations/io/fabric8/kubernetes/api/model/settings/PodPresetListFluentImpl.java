...
public class PodPresetListFluentImpl<A extends PodPresetListFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements PodPresetListFluent<A>{

    private String apiVersion;
    private List<PodPresetBuilder> items;
    private String kind;
    ...
    public A addToItems(int index,PodPreset item){
            if (this.items == null) {this.items = new ArrayList<PodPresetBuilder>();}
...
@Deprecated public List<PodPreset> getItems(){
    ...
    public PodPreset buildMatchingItem(io.fabric8.kubernetes.api.builder.Predicate<PodPresetBuilder> predicate){
            for (PodPresetBuilder item: items) { if(predicate.apply(item)){return item.build();} } return null;
    }

    public A withItems(List<PodPreset> items){
            if (this.items != null) { _visitables.removeAll(this.items);}
            if (items != null) {this.items = new ArrayList<PodPresetBuilder>(); for (PodPreset item : items){this.addToItems(item);}} else { this.items = new ArrayList<PodPresetBuilder>();} return (A) this;
    }

    public A withItems(PodPreset... items){
            if (this.items != null) {this.items.clear();}
            if (items != null) {for (PodPreset item :items){ this.addToItems(item);}} return (A) this;
    }
...
@Deprecated public ListMeta getMetadata(){
    ...
    public boolean equals(Object o){
            ...
            PodPresetListFluentImpl that = (PodPresetListFluentImpl) o;
    ...
    public class ItemsNestedImpl<N> extends PodPresetFluentImpl<PodPresetListFluent.ItemsNested<N>> implements PodPresetListFluent.ItemsNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{

            private final PodPresetBuilder builder;
        private final int index;
    
            ItemsNestedImpl(int index,PodPreset item){
                    this.index = index;
    ...
    public N and(){
            return (N) PodPresetListFluentImpl.this.setToItems(index, builder.build());
    }
    public N endItem(){
            return and();
    }
    ...
    public class MetadataNestedImpl<N> extends ListMetaFluentImpl<PodPresetListFluent.MetadataNested<N>> implements PodPresetListFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) PodPresetListFluentImpl.this.withMetadata(builder.build());
    }
