...
public class BuildConfigListFluentImpl<A extends BuildConfigListFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements BuildConfigListFluent<A>{

    private String apiVersion;
    private List<BuildConfigBuilder> items;
    private String kind;
    ...
    public A addToItems(int index,BuildConfig item){
            if (this.items == null) {this.items = new ArrayList<BuildConfigBuilder>();}
...
@Deprecated public List<BuildConfig> getItems(){
    ...
    public BuildConfig buildMatchingItem(io.fabric8.kubernetes.api.builder.Predicate<BuildConfigBuilder> predicate){
            for (BuildConfigBuilder item: items) { if(predicate.apply(item)){return item.build();} } return null;
    }

    public A withItems(List<BuildConfig> items){
            if (this.items != null) { _visitables.removeAll(this.items);}
            if (items != null) {this.items = new ArrayList<BuildConfigBuilder>(); for (BuildConfig item : items){this.addToItems(item);}} else { this.items = new ArrayList<BuildConfigBuilder>();} return (A) this;
    }

    public A withItems(BuildConfig... items){
            if (this.items != null) {this.items.clear();}
            if (items != null) {for (BuildConfig item :items){ this.addToItems(item);}} return (A) this;
    }
...
@Deprecated public ListMeta getMetadata(){
    ...
    public class ItemsNestedImpl<N> extends BuildConfigFluentImpl<BuildConfigListFluent.ItemsNested<N>> implements BuildConfigListFluent.ItemsNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) BuildConfigListFluentImpl.this.setToItems(index, builder.build());
    }
    public N endItem(){
            return and();
    }
    ...
    public class MetadataNestedImpl<N> extends ListMetaFluentImpl<BuildConfigListFluent.MetadataNested<N>> implements BuildConfigListFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
