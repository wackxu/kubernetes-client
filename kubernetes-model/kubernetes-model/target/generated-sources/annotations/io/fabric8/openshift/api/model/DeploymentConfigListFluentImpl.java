...
public class DeploymentConfigListFluentImpl<A extends DeploymentConfigListFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements DeploymentConfigListFluent<A>{
    ...
    public A addToItems(int index,DeploymentConfig item){
            if (this.items == null) {this.items = new ArrayList<DeploymentConfigBuilder>();}
...
@Deprecated public List<DeploymentConfig> getItems(){
    ...
    public DeploymentConfig buildMatchingItem(io.fabric8.kubernetes.api.builder.Predicate<DeploymentConfigBuilder> predicate){
            for (DeploymentConfigBuilder item: items) { if(predicate.apply(item)){return item.build();} } return null;
    }

    public A withItems(List<DeploymentConfig> items){
            if (this.items != null) { _visitables.removeAll(this.items);}
            if (items != null) {this.items = new ArrayList<DeploymentConfigBuilder>(); for (DeploymentConfig item : items){this.addToItems(item);}} else { this.items = new ArrayList<DeploymentConfigBuilder>();} return (A) this;
    }

    public A withItems(DeploymentConfig... items){
            if (this.items != null) {this.items.clear();}
            if (items != null) {for (DeploymentConfig item :items){ this.addToItems(item);}} return (A) this;
    }
...
@Deprecated public ListMeta getMetadata(){
    ...
    public class ItemsNestedImpl<N> extends DeploymentConfigFluentImpl<DeploymentConfigListFluent.ItemsNested<N>> implements DeploymentConfigListFluent.ItemsNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) DeploymentConfigListFluentImpl.this.setToItems(index, builder.build());
    }
    public N endItem(){
            return and();
    }
    ...
    public class MetadataNestedImpl<N> extends ListMetaFluentImpl<DeploymentConfigListFluent.MetadataNested<N>> implements DeploymentConfigListFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) DeploymentConfigListFluentImpl.this.withMetadata(builder.build());
    }
