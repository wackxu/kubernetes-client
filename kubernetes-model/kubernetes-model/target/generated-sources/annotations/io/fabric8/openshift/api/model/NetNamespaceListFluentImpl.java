...
public class NetNamespaceListFluentImpl<A extends NetNamespaceListFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements NetNamespaceListFluent<A>{
    ...
    private List<NetNamespaceBuilder> items;
    private String kind;
    ...
    public A addToItems(int index,NetNamespace item){
            if (this.items == null) {this.items = new ArrayList<NetNamespaceBuilder>();}
...
@Deprecated public List<NetNamespace> getItems(){
    ...
    public NetNamespace buildMatchingItem(io.fabric8.kubernetes.api.builder.Predicate<NetNamespaceBuilder> predicate){
            for (NetNamespaceBuilder item: items) { if(predicate.apply(item)){return item.build();} } return null;
    }

    public A withItems(List<NetNamespace> items){
            if (this.items != null) { _visitables.removeAll(this.items);}
            if (items != null) {this.items = new ArrayList<NetNamespaceBuilder>(); for (NetNamespace item : items){this.addToItems(item);}} else { this.items = new ArrayList<NetNamespaceBuilder>();} return (A) this;
    }

    public A withItems(NetNamespace... items){
            if (this.items != null) {this.items.clear();}
            if (items != null) {for (NetNamespace item :items){ this.addToItems(item);}} return (A) this;
    }
...
@Deprecated public ListMeta getMetadata(){
    ...
    public NetNamespaceListFluent.MetadataNested<A> withNewMetadata(){
            return new MetadataNestedImpl();
    }

    public NetNamespaceListFluent.MetadataNested<A> withNewMetadataLike(ListMeta item){
            return new MetadataNestedImpl(item);
    }

    public NetNamespaceListFluent.MetadataNested<A> editMetadata(){
            return withNewMetadataLike(getMetadata());
    }

    public NetNamespaceListFluent.MetadataNested<A> editOrNewMetadata(){
            return withNewMetadataLike(getMetadata() != null ? getMetadata(): new ListMetaBuilder().build());
    }

    public NetNamespaceListFluent.MetadataNested<A> editOrNewMetadataLike(ListMeta item){
    ...
    public class ItemsNestedImpl<N> extends NetNamespaceFluentImpl<NetNamespaceListFluent.ItemsNested<N>> implements NetNamespaceListFluent.ItemsNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) NetNamespaceListFluentImpl.this.setToItems(index, builder.build());
    }
    public N endItem(){
            return and();
    }
    ...
    public class MetadataNestedImpl<N> extends ListMetaFluentImpl<NetNamespaceListFluent.MetadataNested<N>> implements NetNamespaceListFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) NetNamespaceListFluentImpl.this.withMetadata(builder.build());
    }
