...
public class OAuthAccessTokenListFluentImpl<A extends OAuthAccessTokenListFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements OAuthAccessTokenListFluent<A>{

    private String apiVersion;
    private List<OAuthAccessTokenBuilder> items;
    private String kind;
    ...
    public A addToItems(int index,OAuthAccessToken item){
            if (this.items == null) {this.items = new ArrayList<OAuthAccessTokenBuilder>();}
...
@Deprecated public List<OAuthAccessToken> getItems(){
    ...
    public OAuthAccessToken buildMatchingItem(io.fabric8.kubernetes.api.builder.Predicate<OAuthAccessTokenBuilder> predicate){
            for (OAuthAccessTokenBuilder item: items) { if(predicate.apply(item)){return item.build();} } return null;
    }

    public A withItems(List<OAuthAccessToken> items){
            if (this.items != null) { _visitables.removeAll(this.items);}
            if (items != null) {this.items = new ArrayList<OAuthAccessTokenBuilder>(); for (OAuthAccessToken item : items){this.addToItems(item);}} else { this.items = new ArrayList<OAuthAccessTokenBuilder>();} return (A) this;
    }
...
@Deprecated public ListMeta getMetadata(){
    ...
    public class ItemsNestedImpl<N> extends OAuthAccessTokenFluentImpl<OAuthAccessTokenListFluent.ItemsNested<N>> implements OAuthAccessTokenListFluent.ItemsNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{

            private final OAuthAccessTokenBuilder builder;
        private final int index;
    
            ItemsNestedImpl(int index,OAuthAccessToken item){
                    this.index = index;
    ...
    public N and(){
            return (N) OAuthAccessTokenListFluentImpl.this.setToItems(index, builder.build());
    }
    public N endItem(){
            return and();
    }
    ...
    public class MetadataNestedImpl<N> extends ListMetaFluentImpl<OAuthAccessTokenListFluent.MetadataNested<N>> implements OAuthAccessTokenListFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
