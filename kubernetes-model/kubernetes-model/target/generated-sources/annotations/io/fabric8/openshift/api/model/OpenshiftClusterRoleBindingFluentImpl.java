...
public class OpenshiftClusterRoleBindingFluentImpl<A extends OpenshiftClusterRoleBindingFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements OpenshiftClusterRoleBindingFluent<A>{
    ...
    public OpenshiftClusterRoleBindingFluentImpl(){
    }
    public OpenshiftClusterRoleBindingFluentImpl(OpenshiftClusterRoleBinding instance){
...
@Deprecated public List<ObjectReference> getSubjects(){
    ...
    public boolean equals(Object o){
            ...
            OpenshiftClusterRoleBindingFluentImpl that = (OpenshiftClusterRoleBindingFluentImpl) o;
    ...
    public class MetadataNestedImpl<N> extends ObjectMetaFluentImpl<OpenshiftClusterRoleBindingFluent.MetadataNested<N>> implements OpenshiftClusterRoleBindingFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) OpenshiftClusterRoleBindingFluentImpl.this.withMetadata(builder.build());
    }
    ...
    public class RoleRefNestedImpl<N> extends ObjectReferenceFluentImpl<OpenshiftClusterRoleBindingFluent.RoleRefNested<N>> implements OpenshiftClusterRoleBindingFluent.RoleRefNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) OpenshiftClusterRoleBindingFluentImpl.this.withRoleRef(builder.build());
    }
    public N endRoleRef(){
            return and();
    }
    ...
    public class SubjectsNestedImpl<N> extends ObjectReferenceFluentImpl<OpenshiftClusterRoleBindingFluent.SubjectsNested<N>> implements OpenshiftClusterRoleBindingFluent.SubjectsNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) OpenshiftClusterRoleBindingFluentImpl.this.setToSubjects(index, builder.build());
    }
    public N endSubject(){
            return and();
    }
