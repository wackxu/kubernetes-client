...
public class OpenshiftRoleBindingListFluentImpl<A extends OpenshiftRoleBindingListFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements OpenshiftRoleBindingListFluent<A>{

    private String apiVersion;
    private List<OpenshiftRoleBindingBuilder> items;
    private String kind;
    private ListMetaBuilder metadata;

    public OpenshiftRoleBindingListFluentImpl(){
    }
    public OpenshiftRoleBindingListFluentImpl(OpenshiftRoleBindingList instance){
    ...
    public A addToItems(int index,OpenshiftRoleBinding item){
            if (this.items == null) {this.items = new ArrayList<OpenshiftRoleBindingBuilder>();}
...
@Deprecated public List<OpenshiftRoleBinding> getItems(){
    ...
    public OpenshiftRoleBinding buildMatchingItem(io.fabric8.kubernetes.api.builder.Predicate<OpenshiftRoleBindingBuilder> predicate){
            for (OpenshiftRoleBindingBuilder item: items) { if(predicate.apply(item)){return item.build();} } return null;
    }

    public A withItems(List<OpenshiftRoleBinding> items){
            if (this.items != null) { _visitables.removeAll(this.items);}
            if (items != null) {this.items = new ArrayList<OpenshiftRoleBindingBuilder>(); for (OpenshiftRoleBinding item : items){this.addToItems(item);}} else { this.items = new ArrayList<OpenshiftRoleBindingBuilder>();} return (A) this;
    }

    public A withItems(OpenshiftRoleBinding... items){
            if (this.items != null) {this.items.clear();}
            if (items != null) {for (OpenshiftRoleBinding item :items){ this.addToItems(item);}} return (A) this;
    }
...
@Deprecated public ListMeta getMetadata(){
    ...
    public boolean equals(Object o){
            ...
            OpenshiftRoleBindingListFluentImpl that = (OpenshiftRoleBindingListFluentImpl) o;
    ...
    public class ItemsNestedImpl<N> extends OpenshiftRoleBindingFluentImpl<OpenshiftRoleBindingListFluent.ItemsNested<N>> implements OpenshiftRoleBindingListFluent.ItemsNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{

            private final OpenshiftRoleBindingBuilder builder;
        private final int index;
    
            ItemsNestedImpl(int index,OpenshiftRoleBinding item){
                    this.index = index;
    ...
    public N and(){
            return (N) OpenshiftRoleBindingListFluentImpl.this.setToItems(index, builder.build());
    }
    public N endItem(){
            return and();
    }
    ...
    public class MetadataNestedImpl<N> extends ListMetaFluentImpl<OpenshiftRoleBindingListFluent.MetadataNested<N>> implements OpenshiftRoleBindingListFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public N and(){
            return (N) OpenshiftRoleBindingListFluentImpl.this.withMetadata(builder.build());
    }
