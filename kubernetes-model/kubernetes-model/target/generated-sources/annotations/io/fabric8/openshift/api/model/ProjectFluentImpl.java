...
public class ProjectFluentImpl<A extends ProjectFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements ProjectFluent<A>{
...
@Deprecated public ProjectSpec getSpec(){
    ...
    public A withSpec(ProjectSpec spec){
            ...
            if (spec!=null){ this.spec= new ProjectSpecBuilder(spec); _visitables.add(this.spec);} return (A) this;
    }
...
@Deprecated public ProjectStatus getStatus(){
    ...
    public A withStatus(ProjectStatus status){
            ...
            if (status!=null){ this.status= new ProjectStatusBuilder(status); _visitables.add(this.status);} return (A) this;
    }
    ...
    public A withNewStatus(String phase){
            return (A)withStatus(new ProjectStatus(phase));
    }
    ...
    public class MetadataNestedImpl<N> extends ObjectMetaFluentImpl<ProjectFluent.MetadataNested<N>> implements ProjectFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public class SpecNestedImpl<N> extends ProjectSpecFluentImpl<ProjectFluent.SpecNested<N>> implements ProjectFluent.SpecNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
    ...
    public class StatusNestedImpl<N> extends ProjectStatusFluentImpl<ProjectFluent.StatusNested<N>> implements ProjectFluent.StatusNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
