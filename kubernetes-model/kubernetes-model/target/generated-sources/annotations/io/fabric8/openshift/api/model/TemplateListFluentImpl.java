...
public class TemplateListFluentImpl<A extends TemplateListFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements TemplateListFluent<A>{

    private String apiVersion;
    private List<TemplateBuilder> items;
    private String kind;
    ...
    public A addToItems(int index,Template item){
            if (this.items == null) {this.items = new ArrayList<TemplateBuilder>();}
...
@Deprecated public List<Template> getItems(){
    ...
    public Template buildMatchingItem(io.fabric8.kubernetes.api.builder.Predicate<TemplateBuilder> predicate){
            for (TemplateBuilder item: items) { if(predicate.apply(item)){return item.build();} } return null;
    }

    public A withItems(List<Template> items){
            if (this.items != null) { _visitables.removeAll(this.items);}
            if (items != null) {this.items = new ArrayList<TemplateBuilder>(); for (Template item : items){this.addToItems(item);}} else { this.items = new ArrayList<TemplateBuilder>();} return (A) this;
    }
...
@Deprecated public ListMeta getMetadata(){
    ...
    public class ItemsNestedImpl<N> extends TemplateFluentImpl<TemplateListFluent.ItemsNested<N>> implements TemplateListFluent.ItemsNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{

            private final TemplateBuilder builder;
        private final int index;
    
            ItemsNestedImpl(int index,Template item){
                    this.index = index;
    ...
    public N and(){
            return (N) TemplateListFluentImpl.this.setToItems(index, builder.build());
    }
    public N endItem(){
            return and();
    }
    ...
    public class MetadataNestedImpl<N> extends ListMetaFluentImpl<TemplateListFluent.MetadataNested<N>> implements TemplateListFluent.MetadataNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
