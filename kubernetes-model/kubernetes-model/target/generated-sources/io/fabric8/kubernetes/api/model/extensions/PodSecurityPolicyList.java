...
@ApiVersion("v1beta1")
@ApiGroup("extensions")
public class PodSecurityPolicyList implements KubernetesResource, KubernetesResourceList<io.fabric8.kubernetes.api.model.extensions.PodSecurityPolicy>
{
    ...
    @JsonProperty("items")
    @Valid
    private List<io.fabric8.kubernetes.api.model.extensions.PodSecurityPolicy> items = new ArrayList<io.fabric8.kubernetes.api.model.extensions.PodSecurityPolicy>();
    /**
     * 
     * (Required)
     * 
