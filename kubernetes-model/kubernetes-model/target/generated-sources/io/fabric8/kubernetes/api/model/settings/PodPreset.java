...
public class PodPreset implements HasMetadata
{
     ...
     * @param spec
     */
    public PodPreset(String apiVersion, String kind, ObjectMeta metadata, PodPresetSpec spec) {
     ...
     */
    @JsonProperty("spec")
    public void setSpec(PodPresetSpec spec) {
        this.spec = spec;
    }
