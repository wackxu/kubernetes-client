...
public class OpenshiftClusterRoleBinding implements HasMetadata
{
     ...
     * 
     */
    public OpenshiftClusterRoleBinding() {
    }
     ...
     * @param roleRef
     */
    public OpenshiftClusterRoleBinding(String apiVersion, List<String> groupNames, String kind, ObjectMeta metadata, ObjectReference roleRef, List<ObjectReference> subjects, List<String> userNames) {
